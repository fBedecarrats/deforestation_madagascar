...
tm_shape(grille_mada) +
  tm_fill(c("treecover_2000", "var_treecover"),
          title = c("Couvert arboré en 2000", "Variation 2000 et 2020"),
          palette = list("Greens", "Reds")) +
...
aoi2 <- init_portfolio(x = aoi, 
                       years = 2000:2020,
                       outdir = "data_s3/mapme/traveltime",
                       tmpdir = "data_s3/mapme/tmp",
                       cores = 12,
                      verbose = TRUE)
aoi2 = get_resources(aoi2, resource = "traveltime",
...
grille_mada2 = get_resources(grille_mada, "traveltime",
                     range_traveltime = c("5k_10k", "10k_20k"))
```
