...
```{r}
portfolio <- init_portfolio(x = grille_mada,
                            outdir = "data_s3/mapme",
                            tmpdir = "data_s3/tmp",
                            years = 2010)
portfolio <- get_resources(portfolio, resources = "chirps")
portfolio <- get_resources(portfolio, resources = "treecover2000")
portfolio <- get_resources(portfolio, resources = "worldpop")

calc_indicators(grille_mada, 
