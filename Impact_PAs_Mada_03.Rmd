...
```{r Création alvéoles, eval = !dispo_grille_mada}
# Ce qui suit jusqu'à la commande "save" ne s'execute que si le résultat n'a pas
# déjà été généré lors d'une exécution précédente.
...
save(grille_mada, grille_zoom, zoom_boite, fond_carte_zoom,
     file = fichier_grille_mada) 
```
...
Maintenant on télécharge les données
...
saveRDS(data, "data_s3/mapme/treeloss/hexa_5sqkm_treeloss.rds")
